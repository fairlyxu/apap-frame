...
%   [VARNAME1,VARNAME2,VARNAME3,VARNAME4] = IMPORTFILE(FILENAME) 读取文本文件
%   FILENAME 中默认选定范围的数据。
%
...
%
% Example:
%   [VarName1,VarName2,VarName3,VarName4] = importfile('G9PQ0282.txt',1,
%   4647);
%
%    另请参阅 TEXTSCAN。

% 由 MATLAB 自动生成于 2014/10/19 17:08:59
